...
const appCss = "/advertising-avengers/assets/styles-Bv26VUWl.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Next-generation creative marketing studio powered by AI." },
...
const $$splitComponentImporter = () => import("./index-Nfn2fgv4.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Next-generation creative marketing studio powered by AI. Cinematic ads, brand campaigns, reels, and high-performance digital growth for modern brands."
    }, {
      property: "og:title",
      content: "Aetheria — AI Creative Studio"
    }, {
      property: "og:description",
      content: "High-performance creative campaigns powered by proprietary AI workflows for brands that demand cinematic excellence."
    }]
  })
});

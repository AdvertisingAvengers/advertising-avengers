...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B2e2Kgfc.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-HmH8-bH9.js"),
    import("./start-CLdvAMNJ.js"),
...
var ROUTER_BASEPATH = "advertising-avengers";
var SERVER_FN_BASE = "/advertising-avengers/_serverFn/";

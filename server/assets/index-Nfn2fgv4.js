import { I as jsxRuntimeExports, Q as reactExports } from "./server-vSSAPvVc.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
function Nav() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "fixed top-0 w-full z-50 px-6 lg:px-10 py-6 flex justify-between items-center mix-blend-difference", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#", className: "text-xl font-semibold tracking-tighter text-white", children: [
      "Aetheria",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent", children: "." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex gap-10 text-xs uppercase tracking-[0.2em] font-medium text-white/90", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#work", className: "hover:text-brand-accent transition-colors", children: "Portfolio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#capabilities", className: "hover:text-brand-accent transition-colors", children: "Solutions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#intelligence", className: "hover:text-brand-accent transition-colors", children: "Intelligence" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "hover:text-brand-accent transition-colors", children: "Connect" })
    ] }),
...
const heroBg = "/advertising-avengers/assets/hero-bg-D62-lvWl.jpg";
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen flex flex-col justify-center items-center px-6 pt-32 pb-20 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-brand-bg/40 via-transparent to-brand-bg" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.span,
        {
          ...
          children: "The AI Creative Powerhouse"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.h1,
        {
          ...
          children: [
            ...
            "Modern ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent", children: "Universe." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "High-performance creative campaigns powered by proprietary AI workflows for brands that demand cinematic excellence and measurable scale."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-brand-muted", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-[0.3em]", children: "Scroll" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-12 bg-gradient-to-b from-white/30 to-transparent" })
    ] })
  ] });
}
const jewelry = "/advertising-avengers/assets/industry-jewelry-BbHQNKgn.jpg";
const health = "/advertising-avengers/assets/industry-health-RiBykXug.jpg";
const realestate = "/advertising-avengers/assets/industry-realestate-CKlI61Rz.jpg";
const tiles = [
...
function IndustryShowcase() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl", children: [
        "Brands we've ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-brand-accent", children: "elevated." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted max-w-sm text-sm", children: "From boutique houses to global enterprises — every vertical, every market." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: tiles.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-bg via-brand-bg/30 to-transparent flex flex-col justify-end p-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] uppercase tracking-[0.3em] text-brand-accent mb-2", children: t.tag }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-serif italic", children: t.title })
          ] })
        ]
      },
      t.title
...
const video = "/advertising-avengers/assets/cap-video-CBCJI8Dl.jpg";
const brand = "/advertising-avengers/assets/cap-brand-CvyQdooL.jpg";
const reels = "/advertising-avengers/assets/cap-reels-BffCdOSI.jpg";
const product = "/advertising-avengers/assets/cap-product-CbfHds0H.jpg";
const creator = "/advertising-avengers/assets/cap-creator-DdgPU3Cw.jpg";
const social = "/advertising-avengers/assets/cap-social-NxoW06ol.jpg";
const cards = [
...
function Capabilities() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "capabilities", className: "py-32 px-6 lg:px-10 bg-brand-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-brand-accent", children: "What We Create" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl mt-3", children: [
          "Six disciplines. ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "One studio." })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted max-w-sm text-sm", children: "A full-stack creative practice engineered for the velocity of the modern internet." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4", children: cards.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-brand-bg via-brand-bg/40 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full flex flex-col justify-between p-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-widest text-white/40", children: c.meta }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif italic text-3xl md:text-4xl", children: c.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "size-9 rounded-full border border-white/15 grid place-items-center group-hover:bg-brand-accent group-hover:border-brand-accent transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block size-2 border-t border-r border-white -rotate-45 translate-x-[-1px]" }) })
            ] })
          ] })
        ]
      },
...
function Intelligence() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "intelligence", className: "py-32 px-6 lg:px-10 bg-brand-surface relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(62,99,255,0.15),transparent_60%)]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-0 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 30 },
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-brand-accent", children: "Intelligence Layer" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl md:text-5xl font-serif italic mt-3 mb-8 text-balance", children: [
              "Where cinematic art meets",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent", children: "data intelligence." })
            ] }),
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      className: `w-1 h-12 rounded-full shrink-0 ${item.accent ? "bg-brand-accent" : "bg-white/20"}`
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-lg font-semibold mb-1", children: item.t }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted text-sm leading-relaxed", children: item.d })
                  ] })
                ]
              },
              item.t
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-8", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-red-500/30 border border-red-500/50" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-yellow-500/30 border border-yellow-500/50" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-2.5 h-2.5 rounded-full bg-emerald-500/30 border border-emerald-500/50" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-[0.25em] font-mono text-brand-muted", children: "Aetheria_Engine / v2.4" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-28 bg-brand-accent/5 rounded-xl border border-brand-accent/20 flex flex-col justify-center p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-brand-muted uppercase tracking-widest mb-2", children: "Campaign ROI" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-serif italic", children: "14.2×" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-28 bg-white/5 rounded-xl border border-white/10 flex flex-col justify-center p-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-brand-muted uppercase tracking-widest mb-2", children: "Retention" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-serif italic", children: "88%" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/[0.02] border border-white/5 rounded-xl p-4 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-widest font-mono text-brand-muted", children: "Engagement / 30d" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] uppercase tracking-widest font-mono text-brand-accent", children: "+127%" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-1 h-20", children: [30, 45, 38, 60, 52, 70, 65, 82, 75, 90, 85, 100].map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: { height: `${h}%` },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2.5", children: [70, 90, 45].map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] font-mono text-brand-muted w-16", children: [
                "CH_",
                String(i + 1).padStart(2, "0")
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-white/10 rounded-full flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] font-mono text-white/60 w-10 text-right", children: [
                w,
                "%"
              ] })
            ] }, i)) })
...
const fashion = "/advertising-avengers/assets/work-fashion-CNAUXint.jpg";
const auto = "/advertising-avengers/assets/work-auto-DCf2qDZ-.jpg";
const beauty = "/advertising-avengers/assets/work-beauty-Zp1NJQnw.jpg";
const fintech = "/advertising-avengers/assets/work-fintech-Bm0DkpB6.jpg";
const works = [
  {
    img: fashion,
...
function Portfolio() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "work", className: "py-32 px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-end justify-between mb-20 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl md:text-6xl font-serif", children: [
        "Selected ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent italic", children: "Artifacts" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted max-w-xs text-sm", children: "A glimpse into the digital narratives we construct for market leaders." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-16 md:gap-y-8 md:pb-32", children: works.map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 40 },
        whileInView: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden rounded-2xl bg-brand-surface group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: w.img,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-5 right-5 bg-black/70 backdrop-blur-xl border border-white/10 rounded-xl p-3.5 min-w-[140px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-mono uppercase tracking-widest text-brand-muted mb-1", children: w.chip.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-serif italic", children: w.chip.value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end gap-0.5 h-5", children: [40, 60, 50, 80, 100].map((h, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: { height: `${h}%` },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xl font-medium", children: w.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted text-sm mt-1", children: w.sub })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent font-mono text-xs", children: w.year })
          ] })
        ]
      },
      w.title
...
function WhyUs() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-32 px-6 lg:px-10 border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16 max-w-3xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] uppercase tracking-[0.3em] text-brand-accent", children: "What We Do" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-serif text-4xl md:text-5xl mt-3 text-balance", children: [
        "Full-spectrum creative ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: "services for modern brands." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-px bg-white/5 rounded-3xl overflow-hidden border border-white/5", children: reasons.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-6 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[10px] text-brand-accent", children: r.n }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px flex-1 bg-white/10" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-3xl md:text-4xl mb-4 group-hover:text-brand-accent transition-colors", children: r.t }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted leading-relaxed max-w-md", children: r.d })
        ]
      },
      r.n
    )) })
...
function Conversion() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-32 px-6 lg:px-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      initial: { opacity: 0, y: 30 },
      whileInView: { opacity: 1, y: 0 },
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(62,99,255,0.2),transparent_70%)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block px-4 py-1.5 border border-white/15 rounded-full text-[10px] uppercase tracking-[0.3em] bg-white/5 backdrop-blur-sm mb-8 text-white/80", children: "Begin the work" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-5xl md:text-7xl font-serif italic mb-6 text-balance", children: [
            "Evolve Your ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-accent", children: "Presence." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-muted mb-12 text-lg max-w-xl mx-auto leading-relaxed", children: "Ready to deploy the next generation of creative marketing? Let's build your growth engine." }),
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "py-12 px-6 lg:px-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-brand-muted uppercase tracking-[0.25em]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "© 2026 Aetheria Studios — Creative Powerhouse" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-brand-accent transition-colors", children: "Privacy" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-brand-accent transition-colors", children: "Terms" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "hover:text-brand-accent transition-colors", children: "AI Ethics" })
    ] })
  ] });
}
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "bg-brand-bg text-white min-h-screen overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(IndustryShowcase, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Capabilities, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Intelligence, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Portfolio, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhyUs, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Conversion, {}),
